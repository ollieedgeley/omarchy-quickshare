...
- QR-code send flows and outbound attachment kinds other than files
...
| LAN transfer         | Advertisement and discovery, TCP endpoint, initiator and responder Connections state machines, inbound supported content, outbound files, PIN, consent, safe writes, and safe source reads |
