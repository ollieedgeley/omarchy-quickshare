/// Deterministic control requests used by the simulator.
mod simulation;
...
#[expect(
    ...
    reason = "Simulator constructors stay in their owned request submodule"
)]
impl Envelope {
...
pub enum Request {
    ...
    /// Finalizes a fully transferred share in a simulated endpoint.
    SimulateComplete {
        /// Stable local share identifier.
        share_id: u64,
    },
